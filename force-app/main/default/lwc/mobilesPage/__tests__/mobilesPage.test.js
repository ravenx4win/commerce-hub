...
import MobilesPage from 'c/mobilesPage';

describe('c-mobiles-page', () => {
    afterEach(() => {
    ...
    it('renders hero header and breadcrumb without errors', () => {
        const element = createElement('c-mobiles-page', {
            is: MobilesPage
        });
        ...
        expect(title.textContent).toContain('Smartphones & Mobiles');

        const breadcrumb = element.shadowRoot.querySelector('.breadcrumb-current');
        expect(breadcrumb).not.toBeNull();
        expect(breadcrumb.textContent).toBe('Mobiles');
    });
    ...
    it('filters products by search input', async () => {
        ...
        expect(title.textContent).toContain('Pixel');
    });
