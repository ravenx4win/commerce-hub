...
import PersonalCarePage from 'c/personalCarePage';

describe('c-personal-care-page', () => {
    afterEach(() => {
    ...
    it('renders hero header and breadcrumb without errors', () => {
        const element = createElement('c-personal-care-page', {
            is: PersonalCarePage
        });
        ...
        expect(title.textContent).toContain('Personal Care & Grooming');

        const breadcrumb = element.shadowRoot.querySelector('.breadcrumb-current');
        expect(breadcrumb).not.toBeNull();
        expect(breadcrumb.textContent).toBe('Personal Care');
    });
    ...
    it('filters products by search input', async () => {
        ...
        expect(title.textContent).toContain('Trimmer');
    });
