...
import ToysGamesPage from 'c/toysGamesPage';

describe('c-toys-games-page', () => {
    afterEach(() => {
    ...
    it('renders hero header and breadcrumb without errors', () => {
        const element = createElement('c-toys-games-page', {
            is: ToysGamesPage
        });
        ...
        expect(title.textContent).toContain('Toys & Games');

        const breadcrumb = element.shadowRoot.querySelector('.breadcrumb-current');
        expect(breadcrumb).not.toBeNull();
        expect(breadcrumb.textContent).toBe('Toys & Games');
    });
