...
import BeautyPage from 'c/beautyPage';

describe('c-beauty-page', () => {
    afterEach(() => {
    ...
    it('renders hero header and breadcrumb without errors', () => {
        const element = createElement('c-beauty-page', {
            is: BeautyPage
        });
        ...
        expect(title.textContent).toContain('Beauty & Personal Care');

        const breadcrumb = element.shadowRoot.querySelector('.breadcrumb-current');
        expect(breadcrumb).not.toBeNull();
        expect(breadcrumb.textContent).toBe('Beauty');
    });
    ...
    it('filters products by search input', async () => {
        ...
        expect(title.textContent).toContain('GlowRadiance');
    });
